  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://backend.abyssiniasoftware.com/api/blogs/${updatedBlog.id}`,
        {
          method: "PUT",
          headers: {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center z-50">
      <div
        ...
        onClick={closeModal}
      ></div>
      <div className="relative bg-gray-300 shadow-lg rounded-lg p-6 max-w-md w-full z-10 items-center">
